...
public class VeroVerticaSqlFormatter extends VeroGenSqlFormatter
{
    public VeroVerticaSqlFormatter(VeroGenExpFormatter expFormatter) {
        super(expFormatter);
        ...
        extends VeroGenSqlFormatter.Formatter
    {
        ...
        {
            builder.append("CREATE LOCAL TEMPORARY TABLE ")
