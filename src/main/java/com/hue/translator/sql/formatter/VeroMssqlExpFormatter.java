...
public class VeroMssqlExpFormatter extends VeroGenExpFormatter
{
    public VeroMssqlExpFormatter() { _formatterType = DBType.MSSQL; }
            ...
            extends VeroGenExpFormatter.Formatter
    {
        ...
        protected String visitCurrentTime(CurrentTime node, Void context)
        {
            ...
            if (node.getType() == CurrentTime.Type.DATE) {
                builder.append("convert(date, ").append("current_timestamp").append(")");
            } else if (node.getType() == CurrentTime.Type.TIME) {
                builder.append("convert(time, ").append("current_timestamp").append(")");
            } else {
        ...
        protected String visitFunctionCall(FunctionCall node, Void context)
        {
            ...
            if (functionName.equals("stddev_pop")) {
                builder.append("stdevp").append('(').append(arguments).append(')');
            } else if (functionName.equals("stddev_samp")) {
                builder.append("stdev").append('(').append(arguments).append(')');
                ...
                builder.append("datepart").append('(').append("year").append(", ").append(arguments).append(')');
            } else if (functionName.equals("quarter")) {
                builder.append("datepart").append('(').append("quarter").append(", ").append(arguments).append(')');
            } else if (functionName.equals("month")) {
                builder.append("datepart").append('(').append("month").append(", ").append(arguments).append(')');
            } else if (functionName.equals("day")) {
                builder.append("datepart").append('(').append("day").append(", ").append(arguments).append(')');
            } else if (functionName.equals("hour")) {
                builder.append("datepart").append('(').append("hour").append(", ").append(arguments).append(')');
            } else if (functionName.equals("minute")) {
                builder.append("datepart").append('(').append("minute").append(", ").append(arguments).append(')');
            } else if (functionName.equals("second")) {
                builder.append("datepart").append('(').append("second").append(", ").append(arguments).append(')');
